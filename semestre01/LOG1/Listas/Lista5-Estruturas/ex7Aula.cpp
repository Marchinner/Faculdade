...
int buscaMaiorIdade(Inscricao aluno[200], int totalAlunos) {
    int contador, maiorIdade, posicao;

    for(contador = 0; contador < totalAlunos; contador++) {
        if(contador == 0) {
            maiorIdade = aluno[contador].idade;
            posicao = contador;
        } else {
            if(aluno[contador].idade > maiorIdade) {
                maiorIdade = aluno[contador].idade;
                posicao = contador;
            }
        }
...
int main() {
    ...
    int totalAlunos, totalArrecadado, posicao;

    Inscricao aluno[200];

    totalAlunos = lerLista(aluno);

    posicao = buscaMaiorIdade(aluno, totalAlunos);
    ...
    cout << "A maior idade é de " << aluno[posicao].idade << " anos" << endl;
